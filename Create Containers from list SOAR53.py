...
def debug_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    l5_cf_retrieve_list_soar53_2__result = phantom.collect2(container=container, datapath=["l5_cf_retrieve_list_soar53_2:custom_function_result.data.listContents","l5_cf_retrieve_list_soar53_2:custom_function_result.data.listContents[1]"])
    ...
    l5_cf_retrieve_list_soar53_2_data_listcontents___priority = [item[1] for item in l5_cf_retrieve_list_soar53_2_data_listcontents]
    ...
    parameters.append({
        ...
        "input_5": l5_cf_retrieve_list_soar53_2_data_listcontents_1_,
        "input_6": None,
        "input_7": None,
        "input_8": None,
        "input_9": None,
