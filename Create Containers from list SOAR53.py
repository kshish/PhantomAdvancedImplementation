...
def debug_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    l5_cf_retrieve_list_soar53_2__result = phantom.collect2(container=container, datapath=["l5_cf_retrieve_list_soar53_2:custom_function_result.data.listContents","l5_cf_retrieve_list_soar53_2:custom_function_result.data.listContents[].priority"])
    l5_cf_retrieve_list_soar53_2_data_listcontents = phantom.collect2(container=container, datapath=["l5_cf_retrieve_list_soar53_2:custom_function_result.data.listContents.*"])

    l5_cf_retrieve_list_soar53_2_data_listcontents = [item[0] for item in l5_cf_retrieve_list_soar53_2__result]
    l5_cf_retrieve_list_soar53_2_data_listcontents___priority = [item[1] for item in l5_cf_retrieve_list_soar53_2__result]
    l5_cf_retrieve_list_soar53_2_data_listcontents__ = [item[0] for item in l5_cf_retrieve_list_soar53_2_data_listcontents]
